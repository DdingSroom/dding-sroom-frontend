...
🏆 2025 명지대학교 창의적 SW 프로그램 경진대회 장려상 수상작
...
- **2025년 8월 17일 ~ 8월 31일 시범 운영**을 거쳐, 명지대학교 **학생지원팀의 승인 하에 9월 1일부터 학교 공식 시스템으로 운영** 시작  

---

## 2. 기존 문제점과 한계

자유롭게 드나들 수 있었던 기존 ‘학생회관 스터디룸’에서는 다음과 같은 문제가 존재
...
띵스룸은 **도서관 앱 수준의 스마트한 예약 시스템**을 학생회관에 그대로 도입
...
<img width="332" height="721" alt="image" src="https://github.com/user-attachments/assets/4561db55-3b0f-4d71-ba56-fece032c62d2" />
...
- 운영 현황: **2025년 8월 17일 ~ 8월 31일 시범 운영 완료 후, 9월 1일부터 공식 운영 중**

---

## 8. 향후 계획 (Frontend)

1. 서비스 내 **건의하기 기능** 및 **띵스룸 공식 이메일**을 통해 들어오는 사용자 요구사항과 학생지원팀의 요청을 상시 확인하고 반영하여 서비스 디벨롭  
2. **Typescript로 마이그레이션** 진행 → 코드 안정성과 유지보수성 강화  
